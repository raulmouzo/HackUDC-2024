      ...
      <div className='flex bg-[#B1E0FC] pb-10 rounded-br-[50px] justify-left items-left'>
        ...
        <div className='flex items-center max-w-40'>
          <div className='flex flex-col justify-center items-center h-full'>
            <h2 className={`text-[90px] text-white mb-5 text-center justify-center font-sans  font-bold ${porcentajeConsumo < 30 ? 'text-white' : porcentajeConsumo < 50 ? 'text-yellow-500' : porcentajeConsumo < 80 ? 'text-green-600' : porcentajeConsumo < 150 ? '' : 'text-red-700'}`}>
              {porcentajeConsumo}%
            </h2>
